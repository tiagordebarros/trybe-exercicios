...
localStorage.setItem('firstname', 'Tiago'); // salva uma entrada com a key = 'firstname' e value = 'Tiago'
localStorage.setItem('lastname', 'Ribeiro de Barros'); // salva uma entrada com a key = 'lastname' e value = 'Ribeiro de Barros'
console.log(localStorage.getItem('lastname')); // retorna o valor 'Ribeiro de Barros'
